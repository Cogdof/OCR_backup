...
folder_path = '/home/mll/v_mll3/OCR_data/deep-text-recognition-benchmark-master/dataset/single/'                  #기존 파일이 저장되어 있는 디렉토리
imagePath = '/home/mll/v_mll3/OCR_data/deep-text-recognition-benchmark-master/dataset/single/' # bounadary가 없는 원본이미지 경로
savePath = '/home/mll/v_mll3/OCR_data/deep-text-recognition-benchmark-master/dataset/seperate/'           #새 파일들을 저장할 디렉토리
