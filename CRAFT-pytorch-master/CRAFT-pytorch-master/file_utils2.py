...
def saveResult(img_file, img, boxes, nn, dirname='./result/', verticals=None, texts=None):
    ...
    # pC마다 설정해 주기 나름..
    clist = os.listdir('./data')
    # 데이터가 있는 디렉토리의 주소를 구한다.
    ddir = os.path.dirname('./data/0001.txt')
    # 두개를 합쳐서 경로를 만든다.
    ...
    print(filename, "Accuracy is ", round(r_accu, 2), "Percision is ", round(r_pccu, 2), "Recall is ", round(r_rccu, 2),
          "F1 Score is", round(r_F1score, 2))
